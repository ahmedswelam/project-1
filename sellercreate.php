...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   if (!validate($name, 1)) {
    ...
    if(count($errors) > 0){
     ...
     $desPath = '../Dashboard/seller/uploads/'.$FinalName;
     ...
     if(move_uploaded_file($tmpPath,$desPath)){
        ...
        $sql = "insert into seller (seller_name,seller_email,seller_pass,seller_num,seller_address,seller_image,seller_info,roles_id) values ('$name','$email','$password','$phone','$address','$FinalName','$about',$role_id)";
        $op  = mysqli_query($con,$sql);
...
?>
          ...
          <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 text-center">
                  <div class="container-fluid ">
                      ...
                      <h1 class="mt-4">تسجيل البائعين</h1>
                      ...
                      <?php } ?>
                        ...
                        <div class="btn-group me-2">
                            <a href='index.php' class="btn btn-sm btn-outline-secondary">Back to Home Page</a>
                        </div>
